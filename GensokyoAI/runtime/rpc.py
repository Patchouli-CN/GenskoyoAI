...
RUNTIME_PROTOCOL_VERSION = "2.2.0"
...
RPC_METHOD_SPECS: tuple[RpcMethodSpec, ...] = (
    ...
    RpcMethodSpec(
        ...
        "initiative_timer_hesitation",
        legacy=True,
        remove_after=LEGACY_RPC_REMOVE_AFTER,
    ),
    RpcMethodSpec(
        "initiative_timer.hesitation.set",
        "initiative_timer_hesitation_set",
        legacy=True,
        remove_after=LEGACY_RPC_REMOVE_AFTER,
    ),
